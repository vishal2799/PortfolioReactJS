...
export const portfolioItems = [
  {
    id: 1,
    image: Home,
    title: 'Budget Tracker Solution',
    desc: 'Power Platform',
    images: [Home, CreateBudget, CreateExpense],
    link: 'https://github.com/vishal2799/EcommerceReactJS',
    tags: ['2024', 'Power Platform', 'Portfoliio'],
    longdesc:
  ...
  },
  {
    id: 2,
    image: Ecom,
    title: 'Ecommerce with ReactJS',
    desc: 'Website',
    images: [Ecom, Ecom2, Ecom3],
    link: 'https://github.com/vishal2799/EcommerceReactJS',
    tags: ['2024', 'Website', 'Portfolio'],
    longdesc:
      'Developed a dynamic e-commerce platform using React, enabling seamless product browsing, cart management, and checkout. Integrated a robust backend to handle product data and user authentication. Enhanced user experience with responsive design, ensuring compatibility across devices. Optimized for performance, offering efficient navigation and fast load times.',
  },
  {
    id: 3,
    image: Home2,
    title: 'Service Desk Canvas App',
    desc: 'Power Platform',
    images: [Home2, CreateTicket, EditDetail],
    link: 'https://github.com/vishal2799/PowerApps-Ticket-Management',
    tags: ['2024', 'Power Platform', 'Portfolio'],
    longdesc:
